...
export const ResetPassword = ({ url }: ResetPasswordProps) => (
  <Html>
    <Head />
    <Preview>Reset your NutriCulture password</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
          ...
          <Text style={paragraph}>
            We received a request to reset your password for your NutriCulture account. 
...
ResetPassword.PreviewProps = {
  url: "https://nutriculture.app/reset-password",
