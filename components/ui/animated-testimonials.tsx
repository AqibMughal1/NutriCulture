...
export const AnimatedTestimonials = ({
  ...
  useEffect(() => {
    // Initialize rotation values on client side only
    setRotationValues(
  ...
  // Prevent hydration mismatch by waiting for rotation values to be initialized
              ...
              {testimonials.map((testimonial, index) => (
                <div
                  ...
                  style={{
                    ...
                    transform: `scale(${index === active ? 1 : 0.95})`,
